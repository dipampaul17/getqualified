...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-medium transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 active:scale-[0.98]",
  {
    variants: {
      variant: {
        default:
          "bg-zinc-900 text-white shadow-lg hover:bg-zinc-800 hover:shadow-xl hover:-translate-y-0.5",
        destructive:
          "bg-red-600 text-white shadow-lg hover:bg-red-700 hover:shadow-xl hover:-translate-y-0.5",
        outline:
          "border border-zinc-200 bg-white hover:bg-zinc-50 hover:border-zinc-300 hover:shadow-md",
        secondary:
          "bg-zinc-100 text-zinc-900 hover:bg-zinc-200 hover:shadow-md",
